 ...
 * @author joel
 */
public class ClsConsultasCuentasPorPagar extends Coneccion{
    public boolean Guardar(clsCuentasPorPagar al){
            PreparedStatement ps =null;
            Connection con= (Connection)getConexion();
            String sql="INSERT INTO cuentas_por_pagar (importe,fecha_vencimiento,fecha_pago,id_factura) "
                    + "values(?,?,?,?)";
        ...
        try {    
            ...
            Logger.getLogger(ClsConsultasCuentasPorPagar.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
        finally{
                try {
    ...
    public List Mostrar()throws Exception{
         ...
         PreparedStatement ps =null;
         Connection con= (Connection)getConexion();
         String sql="select * from cuentas_por_pagar";
         try {
             ps=con.prepareStatement(sql);
             res = ps.executeQuery();
             while (res.next()) {                 
     ...
     public  ClsFactura BuscarFactura(clsCuentasPorPagar am){
    ...
    String sql="SELECT * FROM facturas WHERE id=?";
     ...
     public List BuscarPList(String fecha)throws Exception{
         ...
         PreparedStatement ps =null;
         Connection con= (Connection)getConexion();
         String sql="SELECT * FROM cuentas_por_pagar WHERE fecha_pago=?";
         try {
             ...
             res = ps.executeQuery();
             while (res.next()) {                 
                clsCuentasPorPagar am = new clsCuentasPorPagar();
     ...
     public boolean BusquedaComple(clsCuentasPorPagar al){
    PreparedStatement ps =null;
    Connection con= (Connection)getConexion();
    ResultSet rs=null;
    String sql="SELECT c.id,c.importe,c.fecha_vencimiento,c.fecha_pago,f.numero_factura"
            + " FROM cuentas_por_pagar c,facturas f WHERE c.fecha_pago=? and f.id=c.id_factura";
